        ...
        public static async Task SeedIdentityUserAsync(UserManager<IdentityUser> usermanager)
        {
            ...
            if (user == null)
            {
                ...
                await usermanager.AddToRolesAsync(user, new string[] {
                    MyIdentityRoleNames.RecipeAdmin.ToString(),
                    MyIdentityRoleNames.RecipeUser.ToString()
                });
            }
            ...
            if (user == null)
            {
                ...
                //});
                await usermanager.AddToRoleAsync(user, MyIdentityRoleNames.RecipeUser.ToString());
            }
        }
