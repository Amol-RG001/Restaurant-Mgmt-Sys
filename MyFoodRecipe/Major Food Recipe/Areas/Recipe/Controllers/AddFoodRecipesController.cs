...
namespace Major_Food_Recipe.Areas.Recipe.Controllers
{
    ...
    public class AddFoodRecipesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FoodRecipeId,FoodRecipeName,FoodSubCategoryId")] AddFoodRecipe addFoodRecipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FoodRecipeId,FoodRecipeName,FoodSubCategoryId")] AddFoodRecipe addFoodRecipe)
        {
